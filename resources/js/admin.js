...
if (window.loggedInAdminId) {
    const channelName = `digital-files.user.${window.loggedInAdminId}`;
    ...
    console.warn('No loggedInAdminId – skipping private channel subscription');
}
