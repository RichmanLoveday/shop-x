            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Update Shipping Rule</h3>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="{{ old('name', $shippingRule->name) }}" required>
                                        ...
                                        <select name="type" id="shippingType" class="form-control" required>
                                            ...
                                            @foreach (\App\Enums\ShippingRulesType::cases() as $type)
                                                <option value="{{ $type->value }}"
                                                    {{ old('type', $shippingRule->type?->value) == $type->value ? 'selected' : '' }}>
                                                    {{ $type->label() }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 d-none" id="minimumOrderWrapper">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" name="minimum_amount"
                                            class="form-control minimum_amount"
                                            value="{{ old('minimum_amount', $shippingRule->minimum_amount) }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" name="charge"
                                            class="form-control" value="{{ old('charge', $shippingRule->charge) }}"
                                            required>
