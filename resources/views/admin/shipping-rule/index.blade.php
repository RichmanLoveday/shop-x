                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('admin.shipping-rules.create') }}" class="btn btn-primary btn-3">
                                    ...
                                    @forelse ($shippingRules as $rule)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-secondary">
                                                <span class="badge badge-sm bg-success-lt">
                                                    {{ $rule->type->label() }}
                                                </span>
                                            </td>

                                            <td class="text-secondary">
                                                @if ($rule->type === \App\Enums\ShippingRulesType::MIN_ORDER_AMOUNT)
                                            ...
                                            <td>
                                                <div class="d-flex w-100 justify-content-between space-x-1">
                                                    <a href="{{ route('admin.shipping-rules.edit', $rule->id) }}"
                                                        class="text-decoration-none">
                                                        <i class="ti ti-edit fs-1"></i>
                                                    </a>
                                                    <a href="{{ route('admin.shipping-rules.destroy', $rule->id) }}"
