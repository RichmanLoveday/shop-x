                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-actions">
                            ...
                            <a href="{{ route('admin.shipping-methods.index') }}" class="btn btn-primary btn-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.shipping-methods.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="{{ old('name') }}" placeholder="e.g. Standard Shipping" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" id="shippingCode" class="form-control"
                                            value="{{ old('code') }}" placeholder="e.g. standard" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="min_days" class="form-control"
                                            value="{{ old('min_days') }}" min="0" max="365" placeholder="e.g. 3"
                                            required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="max_days" class="form-control"
                                            value="{{ old('max_days') }}" min="0" max="365" placeholder="e.g. 5"
                                            required>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-secondary">
                                            ...
                                            After creating this method, configure its shipping rates
                                            for specific origin and destination zones.
                                        </div>
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a href="{{ route('admin.shipping-methods.index') }}" class="btn btn-link">
