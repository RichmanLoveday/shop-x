...
<head>
    ...
    <link href="{{ asset('assets/admin/css/tabler-flags.css?1750026890') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-socials.css?1750026890') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-payments.css?1750026890') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-vendors.css?1750026890') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-marketing.css?1750026890') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-themes.css?1750026890') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="{{ asset('assets/admin/css/preview/demo.css?1750026890') }}" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
...
<body>
    ...
    <script src="{{ asset('assets/admin/js/tabler-theme.min.js?1750026890') }}"></script>
    ...
    <script src="{{ asset('assets/admin/js/tabler.min.js?1750026890') }}" defer></script>

    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="{{ asset('assets/admin/js/preview/demo.min.js?1750026890') }}" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
