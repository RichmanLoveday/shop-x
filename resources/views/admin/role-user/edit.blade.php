                            ...
                            <div class="row mb-5">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="name" value="{{ $admin->name }}" class="form-control"
                                            name="name" required>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="password" value="{{ $admin->password_confirmation }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="role_id" id="" class="form-control">
                                            ...
                                            @foreach ($roles as $role)
                                                <option value="{{ $role->id }}" @selected(in_array($role->name, $admin->getRoleNames()->toArray()))>
                                                    {{ $role->name }}
                                                </option>
                                            @endforeach
                                        </select>
