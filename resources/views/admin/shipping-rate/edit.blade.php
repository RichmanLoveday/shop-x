            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.shipping-rates.update', $shippingRate->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="store_id" class="form-control select2 select2-store" required>

                                        {{-- <option value="">
                                            -- Select Vendor --
                                        </option> --}}

                                        <option selected value="{{ $shippingRate->store->id }}">
                                            {{ $shippingRate->store->name }}
                                        </option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="shipping_method_id" class="form-control select2" required>
                                        ...
                                        @foreach ($shippingMethods as $method)
                                            <option value="{{ $method->id }}"
                                                {{ $shippingRate->shipping_method_id == $method->id ? 'selected' : '' }}>
                                    ...
                                    <small class="form-hint">
                                        The delivery method customers will use for this rate.
                                    </small>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="origin_zone_id" class="form-control select2 zone-select"  data-route="{{ route('admin.shipping-zones.name', ['name' => '__NAME__']) }}"
                                        required>
                                        ...
                                        <option selected value="{{ $shippingRate->originZone->id }}">
                                            {{ $shippingRate->originZone->name }}
                                        </option>

                                    </select>

                                    <small class="form-hint">
                                        The zone where the vendor is located.
                                    </small>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="destination_zone_id" class="form-control select2 zone-select"  data-route="{{ route('admin.shipping-zones.name', ['name' => '__NAME__']) }}"
                                        required>

                                        {{-- <option value="">
                                            -- Select Destination Zone --
                                        </option> --}}
                                        <option selected value="{{ $shippingRate->destinationZone->id }}">
                                            {{ $shippingRate->destinationZone->name }}
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="min_order_amount" class="form-control"
                                            value="{{ $shippingRate->min_order_amount }}" min="0" step="0.01"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="max_order_amount" class="form-control"
                                            value="{{ $shippingRate->max_order_amount }}" min="0" step="0.01"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="charge" class="form-control"
                                            value="{{ $shippingRate->charge }}" min="0" step="0.01"
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <label class="form-check form-switch">
                                            ...
                                            <input type="checkbox" class="form-check-input" name="is_active" value="1"
                                                {{ $shippingRate->is_active == true ? 'checked' : '' }}>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-secondary">
                                            ...
                                            shipping method, origin zone, destination zone and
                                            order-value range.
